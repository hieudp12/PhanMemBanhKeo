using BanhKeo_Doan.Báo_cáo_thống_kê;
...
namespace BanhKeo_Doan
{
    public partial class RibbonForm1 : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void CheckAllQuyen(string mand)
        {
            ...
            btnHangTon.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 15));
            btnPhieuNhapKho.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 16));
            btnPhieuXuatChuyen.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 17));
            btnPhieuXuatRaSX.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 18));
            btnKeHoachSX.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 19));
            btnPhieuXuatHuy.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 20));
            btnHoaDonXuatHang.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 21));
            btnDonHang.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 22));
            btnThanhToanNCC.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 23));
            btnThanhToanKH.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 24));
            btnSoThu.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 25));
            btnSoChi.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 26));

            btnBchtToiHan.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 27));
            btnBcHangTonKho.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 28));
            btnTkHangNhapKho.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 29));
            btnTkHangXuatKho.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 30));
            btnTkHangKhachTra.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 31));
            btnThongKeslnl.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 32));

            btnDoanhSoBanHang.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 33));
            btnLoiNhuanTheoDH.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 34));
            barButtonItem40.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 35));
            barButtonItem41.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 36));
            barButtonItem48.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 37));
            barButtonItem46.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 38));
            barButtonItem47.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 39));
            barButtonItem1.Visibility = CheckHienThi.ChuyenDoiHienThi(KiemTraQuyen(mand, 40));
        }
        ...
        private void btnNCC_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            dataGridView1.Columns["NoCu"].DefaultCellStyle.Format = "N0";
        }
        ...
        private void BtnNhanVien_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            dataGridView1.Columns["PhuCap"].DefaultCellStyle.Format = "N0";
            dataGridView1.Columns["TienTrachNhiem"].DefaultCellStyle.Format = "N0";
        }
        ...
        private void BtnBangGia_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            dataGridView1.Columns["GiaBuon"].DefaultCellStyle.Format = "N0";
            dataGridView1.Columns["GiaBanLe"].DefaultCellStyle.Format = "N0";
        ...
        private void btnPhieuXuatHuy_ItemClick(object sender, ItemClickEventArgs e)
        {
             FormPhieuXuatHuy formxuathuy = new FormPhieuXuatHuy();
              formxuathuy.Show();
        }

        private void btnBchtToiHan_ItemClick(object sender, ItemClickEventArgs e)
        {
            BaoCaoNhapXuatTon baocaonhapxuatton = new BaoCaoNhapXuatTon();
            baocaonhapxuatton.Show();
        }

        private void btnBcHangTonKho_ItemClick(object sender, ItemClickEventArgs e)
        {
            BaoCaoHangTonKho baocaohangtonkho = new BaoCaoHangTonKho();
            baocaohangtonkho.Show();
        }

        private void btnTkHangNhapKho_ItemClick(object sender, ItemClickEventArgs e)
        {
            BaoCaoHangNhapKho baocaohangnhapkho = new BaoCaoHangNhapKho();
            baocaohangnhapkho.Show();
        }

        private void btnTkHangXuatKho_ItemClick(object sender, ItemClickEventArgs e)
        {
            BaoCaoHangXuatChuyen baocaohangxuatchuyen = new BaoCaoHangXuatChuyen();
            baocaohangxuatchuyen.Show();
        }

        private void btnThongKeslnl_ItemClick(object sender, ItemClickEventArgs e)
        {
            BaoCaoXuatNguyenLieuSX baocaoxuatnguyenlieusx = new BaoCaoXuatNguyenLieuSX();
            baocaoxuatnguyenlieusx.Show();
        }

        private void barButtonItem1_ItemClick(object sender, ItemClickEventArgs e)
        {
            BaoCaoXuatHuy baocaoxuathuy = new BaoCaoXuatHuy();
            baocaoxuathuy.Show();
        }

        private void barButtonItem2_ItemClick_1(object sender, ItemClickEventArgs e)
        {
            HangHoaTrongKho hangHoaTrongKho = new HangHoaTrongKho();
            hangHoaTrongKho.Show();
        }
    }
}
