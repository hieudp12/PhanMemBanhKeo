...
namespace BanhKeo_Doan.FormVaChucNangNghiepVu.FormVaChucNangDonHang
{
    public partial class ThemHangHoa : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet13.Kho' table. You can move, or remove it, as needed.
            this.khoTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet13.Kho);
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet12.HangHoa' table. You can move, or remove it, as needed.
            //this.hangHoaTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet12.HangHoa);
            LoadCmbBoxHH();
        }
