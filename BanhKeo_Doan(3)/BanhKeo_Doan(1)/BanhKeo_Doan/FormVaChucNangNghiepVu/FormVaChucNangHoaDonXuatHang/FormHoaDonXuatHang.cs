...
namespace BanhKeo_Doan.FormVaChucNangNghiepVu.FormVaChucNangHoaDonXuatHang
{
    public partial class FormHoaDonXuatHang : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet104.KhachHang' table. You can move, or remove it, as needed.
            this.khachHangTableAdapter1.Fill(this.quanLyBanBanhKeo_DoAnDataSet104.KhachHang);
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet101.NhanVien' table. You can move, or remove it, as needed.
            this.nhanVienTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet101.NhanVien);
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet100.KhachHang' table. You can move, or remove it, as needed.
            this.khachHangTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet100.KhachHang);
            HienThiHoaDon();
        }
        ...
        public void HienThiHoaDon()
        {
            ...
            dataHoaDonXuatHang.Columns["TongChuaCK"].DefaultCellStyle.Format = "N0";
            dataHoaDonXuatHang.Columns["ChietKhau"].DefaultCellStyle.Format = "N0";
            dataHoaDonXuatHang.Columns["TongTien"].DefaultCellStyle.Format = "N0";
        }
        ...
        public void HienThiChiTietHoaDon(string maHoaDonDuocChon)
        {
            ...
            dataChiTietHoaDonXuatHang.Columns["DonGiaTruocCK"].DefaultCellStyle.Format = "N0";
            dataChiTietHoaDonXuatHang.Columns["ChietKhau"].DefaultCellStyle.Format = "N0";
            dataChiTietHoaDonXuatHang.Columns["DonGiaSauCK"].DefaultCellStyle.Format = "N0";
            dataChiTietHoaDonXuatHang.Columns["ThanhTien"].DefaultCellStyle.Format = "N0";
        }
        ...
        private void btnXoaHoaDon_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            MessageBox.Show("Xóa hóa đơn xuất hàng thành công.", "Thông báo", MessageBoxButtons.OK);
            HienThiHoaDon();
        }
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            SqlConnection conn = KetNoiCSDL.GetConnection();
            conn.Open();
            int index = cmbBoxKH1.FindStringExact(cmbBoxKH1.Text);
            cmbBoxKH1.SelectedIndex = index;
            string maKH = cmbBoxKH1.SelectedValue?.ToString();
