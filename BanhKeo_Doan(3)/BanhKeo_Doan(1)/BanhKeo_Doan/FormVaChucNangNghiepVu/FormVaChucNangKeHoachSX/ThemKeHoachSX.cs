...
namespace BanhKeo_Doan.FormVaChucNangNghiepVu.FormVaChucNangKeHoachSX
{
    public partial class ThemKeHoachSX : Form
    {
        ...
        private void btnThemKeHoach_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Mã kế hoạch sản xuất không hợp lệ. Vui lòng nhập theo định dạng: KHxxxx-xxx");
                txtMaKeHoach.Focus();
                return;
            }
        ...
        {
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet29.NhanVien' table. You can move, or remove it, as needed.
            this.nhanVienTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet29.NhanVien);
        }
