...
namespace BanhKeo_Doan.FormNghiepVu
{
    public partial class FormKeHoachSanXuat : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet99.NhanVien' table. You can move, or remove it, as needed.
            this.nhanVienTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet99.NhanVien);
            HienThiKeHoachSX();
        }
        ...
        public void HienThiKeHoachSX()
        {
            ...
            string query = "SELECT NgayLap," +
                ...
                " Inner join NhanVien On KeHoachSanXuat.MaNhanVien = NhanVien.MaNhanVien" +
            ...
            dataKeHoachSX.Columns["TongTien"].DefaultCellStyle.Format = "N0";
        }
        ...
        public void HienThiChiTietKeHoachSX(string maKeHoachSxDuocChon)
        {
            ...
            dataChiTietKeHoachSX.Columns["DonGia"].DefaultCellStyle.Format = "N0";
            dataChiTietKeHoachSX.Columns["ThanhTien"].DefaultCellStyle.Format = "N0";
        }
        ...
        public void HienThiDinhLuong(string maKeHoachSxDuocChon)
        {
            ...
            dataDinhLuong.Columns["TongSoLuong"].DefaultCellStyle.Format = "N4";
        }
        ...
        private void btnXoaKeHoach_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            MessageBox.Show("Xóa kế hoạch sản xuất thành công.", "Thông báo", MessageBoxButtons.OK);
            HienThiKeHoachSX();
        }
