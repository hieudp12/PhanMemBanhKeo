...
namespace BanhKeo_Doan.Chuc_nang_danh_muc.Danh_muc_Mat_hang
{
    public partial class ThemHangHoa : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            string checkma = "SELECT * FROM HangHoa WHERE MaHangHoa = '"+txtMahh.Text+"'";
            SqlDataReader reader = ketnoiCSDL.ExecuteReader(checkma);
            if (reader.Read())
            {
                MessageBox.Show("Mã hàng hóa này đã tồn tại!", "Thông báo", MessageBoxButtons.OK);
                return;
            }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (tabControl1.SelectedTab == tabPage2)
            {
                ...
                try
                {
                    ...
                    dtDl.Columns["SoLuong"].DefaultCellStyle.Format = "N4";
