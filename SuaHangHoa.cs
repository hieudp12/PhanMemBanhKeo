...
namespace BanhKeo_Doan.FormVaChucNangNghiepVu.FormVaChucNangDonHang
{
    public partial class SuaHangHoa : Form
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "UPDATE ChiTietDonHang SET " +
                    "SoLuong = @SoLuong, " +
        ...
        {           
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet44.Kho' table. You can move, or remove it, as needed.
            this.khoTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet44.Kho);
            // TODO: This line of code loads data into the 'quanLyBanBanhKeo_DoAnDataSet45.HangHoa' table. You can move, or remove it, as needed.
            this.hangHoaTableAdapter.Fill(this.quanLyBanBanhKeo_DoAnDataSet45.HangHoa);
